...
<nav class="navbar w-fill h-14 bg-neutral-800 border-b-4 border-blue-600 flex items-center justify-between">
    ...
    <div class="navbar-right flex">
        <div class="navbar-icons">
            <a href="#" class="bg-neutral-600 hover:bg-neutral-400 text-neutral-800 transition-colors h-8 w-8 flex items-center justify-center rounded-sm">
        ...
        <div class="search-bar flex mx-4 overflow-hidden rounded-sm items-center">
            <form action="{{ url('search') }}" method="GET">
                <div class="input-group relative flex flex-nowrap rounded">
                    ...
                    <button class="input-group-text flex h-8 items-center px-3 py-1.5 text-base font-normal text-neutral-50 bg-neutral-600 text-center whitespace-nowrap hover:bg-neutral-500 transition-colors">
